...
[Prompt]
Here is group 22 of the table. Infer the LOINC axes for every row.

row_id	TEST_NAME	UNIT	n	p_missing	deciles	LongName	prefix_meaning	suffix_meaning
1341	asetoniaineet(kval),virtsasta,osatutk.		632	100				
1342	asetoniaineet(kval),virtsasta,vieritesti		476	100				
1343	buprenorfiini(kval),virtsasta		135	100				
1344	erytrosyytit(kval),virtsasta,vieritesti		469	100				
1345	glukoosi(kval),virtsasta,osatutk.		632	100				
1346	glukoosi(kval),virtsasta,vieritesti		479	100				
1347	kannabis(kval),virtsasta		137	100				
1348	klonatsepaamin(7acl)osoitusvirtsasta.		289	100				
1349	kokaiini(kval),virtsasta		135	100				
1350	leukosyytit(kval),virtsasta,vieritesti		481	100				
1351	leukosyytit,virtsasta,osoitus,osatutk.		632	100				
1352	metadoni(kval),virtsasta		135	100				
1353	metamfetamiini(kval),virtsasta		135	100				
1354	metyylifenidaatinosoitus,virtsasta		288	100				
1355	nitriitti(kval),virtsasta,osatutk.		632	100				
1356	nitriitti(kval),virtsasta,vieritesti		482	100				
1357	opiaatit(kval),virtsasta		137	100				
1358	proteiini(kval),virtsasta,vieritesti		480	100				
1359	proteiini,(kval),virtsasta,osatutk.		632	100				
1360	tramadol(kval),virtsasta		135	100				
1361	trisyklisetantidepressantit(kval),virtsasta		135	100				
1362	u-albumiini(kval)tykslab.osat.		321	100			Urine	
1363	u-asetoniaineet(kval)tykslabosat.		321	100			Urine	
1364	u-buprenorfiini(kval),virtsasta		131	100			Urine	
1365	u-erytrosyytit(kval)tykslab.osat.		321	100			Urine	
1366	u-glukoosi(kval)tykslabosastutk.		321	100			Urine	
1367	u-leukosyytit(kval)tykslab.osat.		321	100			Urine	
1368	u-trisyklisetantidepressantit(kval)		142	100			Urine	
1369	veri,virtsasta(osoitus),osatutk.		632	100				
