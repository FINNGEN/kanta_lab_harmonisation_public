...
|LABfi_ALL |WARNING |LAB: not APPROVED Invalid lab unit                             |Found 623 not APPROVED lab source codes where unit is not in validUnitsList or is NA      |
...
|LABfi_ALL |WARNING |LAB: not APPROVED Invalid lab quantity                         |Found 522 not APPROVED lab source codes where test unit does not agree with omop_quantity |
