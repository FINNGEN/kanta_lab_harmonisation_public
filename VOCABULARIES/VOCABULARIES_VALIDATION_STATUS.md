...
|LABfi_ALL |ERROR   |LAB: APPROVED Invalid lab quantity                             |Found 1 APPROVED lab source codes where test unit does not agree with omop_quantity       |
|LABfi_ALL |WARNING |LAB: not APPROVED Invalid lab quantity                         |Found 510 not APPROVED lab source codes where test unit does not agree with omop_quantity |
...
|LABfi_ALL |ERROR   |TEST_NAME_ABBREVIATION source_unit_clean_fix pair valid        |Number of failed rules:  4                                                                |
